  ...
  if ( typeof ynabToolKit !== "undefined"  && ynabToolKit.actOnChangeInit === true ) {
    ...
    ynabToolKit.exportTransactions = new function()  { // Keep feature functions contained within this
      ...
      this.invoke = function() {
        ...
        var exportButton = '<button id="export-transactions" class="ember-view button"><i class="ember-view flaticon stroke download-document"></i> Export </button>'
        $(exportButton).insertAfter(".accounts-toolbar .accounts-toolbar-edit-transaction");
        $('#export-transactions').click(function() { downloadTransactions(); });
      ...
      this.observe = function(changedNodes) {
        ...
        if (location.href.endsWith('/accounts') && !$('.download-document').length ) {
