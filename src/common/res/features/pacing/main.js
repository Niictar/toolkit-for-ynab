(function poll() {
  if ( typeof ynabToolKit !== "undefined" && ynabToolKit.actOnChangeInit === true ) {
    ...
    ynabToolKit.insertPacingColumns = function ()  {
		...
		/* * /
		console.log('Was:');
		console.log(ynabToolKit.presentTotal);
		console.log(ynabToolKit.cachedTotal);
		/* */

		// Evaluate current funds available
		ynabToolKit.presentTotal = ynabToolKit.availableBalanceSnapshot();

		// Compare with previously stored value. If different, update the collumns
		if ( ynabToolKit.cachedTotal === 'init' || (ynabToolKit.presentTotal !== ynabToolKit.cachedTotal) ) {
			updatePacingColumns();
			ynabToolKit.cachedTotal = ynabToolKit.availableBalanceSnapshot();
		};
